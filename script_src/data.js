...
const data = [
    ...
    },
    {
        title: "Self Care",
        timeframe: {
            daily: { current: randomTime(2), previous: randomTime(2)},
            weekly: { current: randomTime(3), previous: randomTime(5)},
            monthly: { current: randomTime(9), previous: randomTime(10)}
        },
