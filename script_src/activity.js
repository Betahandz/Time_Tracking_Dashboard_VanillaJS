        ...
        return `<div class="activity round">
            ...
            <div class="info round">
                ...
                <div class="info-detail">
                    <p class="hours"><span class="number">${timing === 'w' ? weekly.current : timing === 'd' ? daily.current : monthly.current}</span>hrs</p>
                    <p class="previous">${timing === 'd' ? "" : "Last"} <span class="cal">${timing === 'w' ? "week" : timing === 'd' ? "yesterday" : "month"}</span> - <span class="digit">${timing === 'w' ? weekly.previous : timing === 'd' ? daily.previous : monthly.previous}</span>hrs</p>
                </div>
            </div>
        </div>`
    })
